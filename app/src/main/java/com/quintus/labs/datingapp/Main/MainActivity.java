...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rowItems.add(cards);
        cards = new Cards("5", "Srutimayee Sen", "20", "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQvTxYUT6bZPqjEBuq8y88YFVIAHaIAdl6-6hk-eP-9RIlOypt8&usqp=CAU", "chulbuli nautankibaj ", "Drawing", 1200,R.raw.test);
        rowItems.add(cards);
